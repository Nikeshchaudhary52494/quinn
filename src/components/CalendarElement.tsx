...
const CalendarElement = forwardRef<HTMLDivElement, CalendarElementProps>(
  ({ dayData, isCurrentMonth }, ref: Ref<HTMLDivElement>) => {
...
CalendarElement.displayName = "CalendarElement";
